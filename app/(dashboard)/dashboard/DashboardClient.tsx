  ...
  return (
    <>
      ...
      <section className={styles.quickActions}>
        <Link href="/samples/new" prefetch={false} className={styles.quickActionCard}>
          <svg className={styles.quickActionIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="12" cy="12" r="10" />
            <line x1="12" y1="8" x2="12" y2="16" />
            <line x1="8" y1="12" x2="16" y2="12" />
          </svg>
          <span className={styles.quickActionLabel}>Log New Sample</span>
        </Link>
        <Link href="/scan" prefetch={false} className={styles.quickActionCard}>
          <svg className={styles.quickActionIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z" />
            <circle cx="12" cy="13" r="4" />
          </svg>
          <span className={styles.quickActionLabel}>Scan QR Code</span>
        </Link>
      </section>
